...
import './deleteadministratortable.css'

const DeleteAdministratorRecord=(props)=> {
    ...
    return (
      <Modal
        ...
        centered
        id="modalDeleteAdministratorRecordId"
      >
        <Modal.Header closeButton>
        </Modal.Header>
        <Modal.Body>
            <Container className="deleteAdministratorRecordClass">
                <Row>
                    <Col>
                        <TitleModalDelete>
...
DeleteAdministratorRecord.propTypes = {
    name : PropTypes.string
}


export default DeleteAdministratorRecord