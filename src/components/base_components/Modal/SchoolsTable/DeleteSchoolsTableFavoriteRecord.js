...
import './deleteschoolsfavoritetable.css'

const DeleteSchoolsTableFavoriteRecord=(props)=> {
    ...
    return (
      <Modal
        ...
        centered
        id="modalDeleteSchoolsTableFavoriteRecordId"
      >
        <Modal.Header closeButton>
        </Modal.Header>
        <Modal.Body>
            <Container className="deleteSchoolsTableFavoriteRecordClass">
                <Row>
                    <Col>
                        <TitleModalDelete>
                ...
                <Row>
                    ...
                    <Col className="deleteButton">
                        ...
                        <ButtonPrimary
                            id="buttonModalDeleteSchoolsFavoriteTableRecord"
                            width="90px" 
                            background="#a31818"
                            name="Delete"
...
DeleteSchoolsTableFavoriteRecord.propTypes = {
    name : PropTypes.string
}


export default DeleteSchoolsTableFavoriteRecord