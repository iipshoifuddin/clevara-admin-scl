...
import './detailschoolstablefavoriterecord.css';

const DetailSchoolsTableFavoriteRecord=(props)=> {
    ...
    return (
      <Modal
        ...
        centered
        id="modalSchoolsTableFavoriteRecordId" 
        >
...
DetailSchoolsTableFavoriteRecord.propTypes = {
    name : PropTypes.string
}


export default DetailSchoolsTableFavoriteRecord