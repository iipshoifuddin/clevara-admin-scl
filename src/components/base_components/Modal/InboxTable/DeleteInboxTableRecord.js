...
import './deleteinboxtablerecord.css'

const DeleteInboxTableRecord=(props)=> {
    ...
    return (
      <Modal
        ...
        centered
        id="modalDeleteInboxTableRecordId"
      >
        <Modal.Header closeButton>
        </Modal.Header>
        <Modal.Body>
            <Container className="deleteInboxTableRecordClass">
                <Row>
                    <Col>
                        <TitleModalDelete>
                ...
                <Row>
                    <Col className="cancelButton">
                        <Link 
                            className="buttonBackModalInboxTableRecord"
                    ...
                    <Col className="deleteButton">
                        ...
                        <ButtonPrimary
                            id="buttonModalDeleteInboxTableRecord"
                            width="90px" 
                            background="#a31818"
                            name="Delete"
...
DeleteInboxTableRecord.propTypes = {
    name : PropTypes.string
}


export default DeleteInboxTableRecord