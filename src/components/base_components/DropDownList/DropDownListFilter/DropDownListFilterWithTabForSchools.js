...
import './dropdownlistfilterwithtabforschools.css';
import '../../Icon/Icon';

const DropDownListFilterWithTabForSchools = props => {
    ...
    return (
        <>
            <Container id="dropDownListFilterWithTabForSchoolsContainer">
                <Row>
                    <Col>
                        <TitleAdministrator>Show Data</TitleAdministrator>                        
                    </Col>
                </Row>
                <Row>
                    <Col lg={4}>
                        <ButtonTab id="defaultBadgesDDLFWTFS" className="tablinkDropDownListWithTabForSchools" onClick={(e)=>{badgesFunction(e, props.storeBadges[0].idBadges)}}>{props.storeBadges[0].name}</ButtonTab>
                        <ButtonTab className="tablinkDropDownListWithTabForSchools" onClick={(e)=>{badgesFunction(e, props.storeBadges[1].idBadges)}}>{props.storeBadges[1].name}</ButtonTab>
                    </Col>
                    <Col lg={5} className="colForOffecerTotal">
                        <DivSumOfOperator>Total Operator : {props.officerTotal}</DivSumOfOperator>
                    </Col>
...
DropDownListFilterWithTabForSchools.propTypes = {
    name : PropTypes.string
}

export default DropDownListFilterWithTabForSchools;