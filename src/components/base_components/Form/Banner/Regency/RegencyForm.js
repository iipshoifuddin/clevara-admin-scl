...
const RegencyForm = (props)=> {
    const [limitLoopJumbotron, setLimitLoopJumbotron]=useState(1);
    return (
        <>
            <Container id="regencyFormBannerContainer">
                <Row>
                    <Col>
                ...
                <Row>
                    <Col>
                        <DivTitleFormInput>Cari Kota/Kabupaten</DivTitleFormInput>
                    </Col>
                </Row>
                <Row>
                    <Col className="divColbackgroundInput">
                ...
                <Row>
                    <Col></Col>
                    <Col className="colButtonSaveCancelRegencyBanner" lg={2}>
                        <ButtonSecondary
                            width="81px"
                            name="Cancel"
                            onClick={()=>{}}
